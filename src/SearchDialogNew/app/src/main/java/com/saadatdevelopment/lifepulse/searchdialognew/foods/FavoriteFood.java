...
/**
 * Class to allow users to favorite their best meals to find them easily later
 */
public class FavoriteFood extends AppCompatActivity implements View.OnClickListener
{
    //Declare variables
    ...
    private static final String RADIO_BUTTON_CHECKED = "RadioButtonCheckedFavFood";
    private static final String MY_PREFERENCES = "MyPreferences";
    private final String TAG = "APIFavoriteFood";
...
//        //Notify the adapter of change in data
    ...
    {
        String url = "https://www.saadatdevelopment.com/apis/lifepulse/favorite_foods.json";
