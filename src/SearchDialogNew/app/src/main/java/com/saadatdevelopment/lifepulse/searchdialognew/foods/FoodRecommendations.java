...
/**
 * Class to allow users to see recommended food
 */
public class FoodRecommendations extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageButton filterFood;
    Switch changeLayouts;
    TextView changeViews;

    Dialog dialog;
    int index;
    SharedPreferences radioButtonIndicator;
    private RadioGroup rg;
    private static final String RADIO_BUTTON_CHECKED = "RadioButtonCheckedRecoFood";
    private static final String MY_PREFERENCES = "MyPreferences";
    private final String TAG = "APIRecommendedFood";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar1.setTitle(Html.fromHtml("<font color='#7d2709'>Food Recommendations</font>"));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        setContentView(R.layout.activity_food_recommendations);

        //Find the views
        changeLayouts= (Switch) findViewById(R.id.changeLayouts);
        //Set OnClick listener for the switch
        changeLayouts.setOnClickListener(this);

        changeViews = (TextView) findViewById(R.id.changeViews);
        //Set the text of the switch
        changeViews.setText(R.string.listView);

        filterFood = (ImageButton) (findViewById(R.id.filters));

        this.recyclerView = (RecyclerView) findViewById(R.id.recommendedFoodRecyclerView);
...
//        final Intent intentToFood = new Intent(this, .class);
        ...
        findViewById(R.id.btnSearchFoodRecommendations).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new SimpleSearchDialogCompat(FoodRecommendations.this, "Search...", "Search for food...", null,
                        initData(), new SearchResultListener<Searchable>() {
                    @Override
                    public void onSelected(BaseSearchDialogCompat baseSearchDialogCompat, Searchable searchable, int i) {
                        Toast.makeText(FoodRecommendations.this, ""+searchable.getTitle(), Toast.LENGTH_SHORT).show();
...
//    }
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.changeLayouts)
        {
            //If the button is checked/toggled
            if(changeLayouts.isChecked())
            {
                //Set the text to grid
                changeViews.setText(R.string.gridView);
    ...
    {
        String url = "https://www.saadatdevelopment.com/apis/lifepulse/recommended_foods.json";
